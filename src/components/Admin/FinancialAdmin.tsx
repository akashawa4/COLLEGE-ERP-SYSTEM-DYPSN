  ...
  return (
    <div className="p-4 lg:p-6 space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Financial Administration</h1>
          <p className="text-gray-600 mt-1">Manage ledgers, refunds, and financial reconciliations</p>
        </div>
      </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-yellow-600">₹{getTotalRefunds().toLocaleString()}</p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className={`text-2xl font-bold ${getNetBalance() >= 0 ? 'text-green-600' : 'text-red-600'}`}>
